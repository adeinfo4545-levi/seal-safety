...
const printCertificate = (data: any) => {
  ...
  const trainerSignatureImg = data.nama_trainer
    ? `<img src="${API_BASE_URL}/signatures/${safeCertNumber}.png" style="height: 50px; max-width: 140px; object-fit: contain;" onerror="this.style.display='none'" />`
  ...
  const html = `
    <html>
      <head>
        ...
        <style>
          @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;700;800;900&family=Playfair+Display:ital,wght@0,700;1,400&display=swap');
          @page {
            size: A4 landscape;
            margin: 0;
          }
          ...
          .top-header {
            ...
            background-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="120" height="20"><text x="0" y="14" fill="rgba(8, 95, 99, 0.05)" font-size="8" font-family="sans-serif" font-weight="900" letter-spacing="2">STC STC STC</text></svg>');
          ...
          .cert-body-wrapper {
            flex-grow: 1;
            background-color: #ffffff;
            background-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="360" height="50" viewBox="0 0 360 50"><text x="10" y="20" fill="rgba(31, 41, 55, 0.022)" font-size="8" font-family="sans-serif" font-weight="900" letter-spacing="1">SEAL TRAINING CENTER SEAL TRAINING CENTER</text><text x="40" y="40" fill="rgba(31, 41, 55, 0.022)" font-size="8" font-family="sans-serif" font-weight="900" letter-spacing="1">SEAL TRAINING CENTER SEAL TRAINING CENTER</text></svg>');
            background-repeat: repeat;
          ...
          <div class="inner-border">
            ...
            <div class="top-header">
              ...
              <div class="qr-code-box">
                <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${encodeURIComponent(verificationUrl)}" style="width: 70px; height: 70px; display: block;" />
              </div>
              ...
              <div class="logo-container">
                <svg width="40" height="40" viewBox="0 0 100 100">
                  <path d="M50 10 C65 10 80 25 80 45 C80 65 65 80 50 80 C35 80 20 65 20 45 C20 25 35 10 50 10" fill="none" stroke="#00d2c4" stroke-width="8" stroke-dasharray="140 100" stroke-linecap="round" transform="rotate(30 50 50)" />
                  <path d="M50 20 C60 20 70 30 70 45 C70 60 60 70 50 70 C40 70 30 60 30 45 C30 30 40 20 50 20" fill="none" stroke="#a2e800" stroke-width="8" stroke-dasharray="100 100" stroke-linecap="round" transform="rotate(-45 50 50)" />
                  <path d="M50 30 C55 30 60 35 60 45 C60 55 55 60 50 60 C45 60 40 55 40 45 C40 35 45 30 50 30" fill="none" stroke="#0072bc" stroke-width="6" stroke-linecap="round" transform="rotate(135 50 50)" />
                  <path d="M50 35 C58 35 62 43 62 50 C62 58 50 66 50 66 C50 66 38 58 38 50 C38 43 42 35 50 35 Z" fill="#b17024" />
                  <path d="M50 38 C55 38 58 43 58 49 C58 55 50 61 50 61 C50 61 42 55 42 49 C42 43 45 38 50 38 Z" fill="#000000" />
                  <circle cx="48" cy="48" r="2.5" fill="#ffffff" />
                </svg>
                <div class="logo-text-block">
                  <span class="logo-main">SEAL</span>
                  <div class="logo-sub">TRAINING & CONSULTING</div>
                  <span class="logo-desc">Suryasegarahana Evaluation Analysis & Learning</span>
                </div>
              </div>
            </div>
            ...
            <div class="cert-body-wrapper">
              ...
              <div class="cert-body">
                <div>
                  <div class="train-center-title">SEAL Training Center</div>
                  <div class="certifies-text">Certifies that</div>
                  <div class="participant-name">${data.nama_peserta}</div>
                  <div class="nik-text">NIK: ${data.nik || '-'}</div>
                </div>

                <div>
                  <div class="completed-text">Has successfully completed of</div>
                  <div class="program-name">${data.nama_program}</div>
                </div>

                <div>
                  <div class="completion-date">Date of Completion (dd/mm/yyyy) : <span style="font-weight: 900;">${formatDate(data.tanggal_terbit)}</span></div>
                  <div class="validity-text">Valid for 2 (two) years from date attended</div>
                </div>
              </div>

              <!-- Signatures Section -->
              <div class="signatures-section">
                <!-- Left: Trainer Signature -->
                <div class="signature-box">
                  <div class="sig-img-container">
                    ${trainerSignatureImg}
                  </div>
                  <div class="sig-line">
                    ${data.nama_trainer || 'INSTRUCTOR'}
                  </div>
                ...
                <div class="signature-box">
                  <div class="sig-img-container">
                    <svg width="120" height="45" viewBox="0 0 130 50">
                      <path d="M 10 38 C 25 30, 38 12, 42 12 C 46 12, 50 38, 58 38 C 66 38, 75 22, 79 22 C 83 22, 87 35, 95 30 C 103 26, 107 12, 115 12" fill="none" stroke="#1f2937" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M 18 30 C 35 30, 52 30, 85 28" fill="none" stroke="#1f2937" stroke-width="1.5" stroke-linecap="round" />
                    </svg>
                  </div>
                  <div class="sig-line">
                    SURYADINATA, SE, CPRM
                  </div>
                  <div class="sig-title" style="line-height: 1.2;">
                    Direktur SEAL Training Center<br/>
              ...
              <div class="footer-section">
                <div class="cert-num-block">
                  Certificate Number: ${data.nomor_sertifikat}
                </div>
                <div class="footer-url-text">
                  Check your certificate number registration on our website<br/>
                  <span style="color: #085f63; text-decoration: underline;">www.sealtrainingcenter.com/certificate</span>
                </div>
              </div>
...
const generateCertificatePDF = async (cert: any, libraries: any): Promise<Blob> => {
  const { html2canvas, jsPDF } = libraries;
  ...
  const trainerSignatureImg = cert.nama_trainer
    ? `<img src="${API_BASE_URL}/signatures/${safeCertNumber}.png" style="height: 50px; max-width: 140px; object-fit: contain;" />`
    : `<div style="height: 50px;"></div>`;
  ...
  container.innerHTML = `
    ...
    ">
      ...
      ">
        ...
        <!-- Top Cyan Section with STC Watermark -->
        <div style="
          background-color: #e2f4f6;
          background-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="120" height="20"><text x="0" y="14" fill="rgba(8, 95, 99, 0.05)" font-size="8" font-family="sans-serif" font-weight="900" letter-spacing="2">STC STC STC</text></svg>');
          background-repeat: repeat;
        ...
        ">
          <!-- Left: QR Code -->
          <div style="border: 2px solid #000000; padding: 2px; background: #ffffff; display: flex; align-items: center; justify-content: center; shrink: 0;">
            <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${encodeURIComponent(verificationUrl)}" style="width: 75px; height: 75px; display: block;" />
          </div>

          <!-- Middle: Dark Teal Banner -->
          <div style="
            background-color: #085f63;
            color: #ffffff;
            text-align: center;
          ...
          <div style="display: flex; align-items: center; gap: 8px; flex-shrink: 0;">
            ...
            <div style="display: flex; flex-direction: column; align-items: flex-start;">
              <span style="font-size: 28px; font-weight: 900; color: #000000; line-height: 0.8; letter-spacing: 0.5px;">SEAL</span>
              <div style="font-size: 8.5px; font-weight: 800; color: #ffffff; background-color: #000000; padding: 2px 4px; letter-spacing: 1px; margin-top: 2px; width: 100%; text-align: center; box-sizing: border-box;">TRAINING & CONSULTING</div>
              <span style="font-size: 7px; font-weight: 700; color: #1f2937; margin-top: 2px; white-space: nowrap; font-style: italic;">Suryasegarahana Evaluation Analysis & Learning</span>
            </div>
          </div>
        </div>

        <!-- White Body Section with SEAL Watermark -->
        <div style="
          flex-grow: 1;
          background-color: #ffffff;
          background-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="360" height="50" viewBox="0 0 360 50"><text x="10" y="20" fill="rgba(31, 41, 55, 0.022)" font-size="8" font-family="sans-serif" font-weight="900" letter-spacing="1">SEAL TRAINING CENTER SEAL TRAINING CENTER</text><text x="40" y="40" fill="rgba(31, 41, 55, 0.022)" font-size="8" font-family="sans-serif" font-weight="900" letter-spacing="1">SEAL TRAINING CENTER SEAL TRAINING CENTER</text></svg>');
        ...
        ">
          ...
          <!-- Middle Body Text -->
          <div style="text-align: center; flex-grow: 1; display: flex; flex-direction: column; justify-content: space-around; margin: 5px 0;">
            <div>
              <div style="font-size: 21px; font-weight: 800; color: #1f2937; letter-spacing: 1px;">SEAL Training Center</div>
              <div style="font-size: 14px; font-style: italic; color: #4b5563; margin-top: 2px;">Certifies that</div>
              <div style="font-size: 38px; font-weight: 900; color: #000000; margin: 8px 0; text-transform: uppercase; letter-spacing: 0.5px;">${cert.nama_peserta}</div>
              <div style="font-size: 13px; font-weight: 700; color: #1f2937; font-family: monospace;">NIK: ${cert.nik || '-'}</div>
            </div>

            <div>
              <div style="font-size: 15px; font-weight: 800; color: #1f2937; text-transform: uppercase; letter-spacing: 0.5px;">Has successfully completed of</div>
              <div style="font-size: 26px; font-weight: 800; color: #8e1c1c; text-transform: uppercase; letter-spacing: 0.5px; margin: 4px 0;">${cert.nama_program}</div>
            </div>

            <div>
              <div style="font-size: 14px; font-weight: 800; color: #1f2937;">Date of Completion (dd/mm/yyyy) : <span style="font-weight: 900;">${formatDate(cert.tanggal_terbit)}</span></div>
              <div style="font-size: 12px; font-weight: 800; font-style: italic; color: #1f2937; margin-top: 2px;">Valid for 2 (two) years from date attended</div>
            </div>
          </div>

          <!-- Signatures Section -->
          <div style="width: 100%; display: flex; justify-content: space-between; align-items: flex-end; margin-top: 10px; padding: 0 10px; box-sizing: border-box;">
            <!-- Left: Trainer Signature -->
            <div style="text-align: center; width: 220px; display: flex; flex-direction: column; align-items: center;">
              <div style="height: 50px; display: flex; align-items: center; justify-content: center;">
                ${trainerSignatureImg}
              </div>
              <div style="width: 100%; border-top: 1.5px solid #1f2937; margin-top: 2px; padding-top: 4px; font-size: 11px; font-weight: 800; color: #000000; text-transform: uppercase; letter-spacing: 0.5px;">
                ${cert.nama_trainer || 'INSTRUCTOR'}
              </div>
              <div style="font-size: 9.5px; color: #4b5563; font-weight: 700; margin-top: 2px;">Trainer</div>
            </div>
            ...
            <div style="text-align: center; width: 220px; display: flex; flex-direction: column; align-items: center;">
              ...
              <div style="font-size: 9.5px; color: #4b5563; font-weight: 700; margin-top: 2px; line-height: 1.2;">
                Direktur SEAL Training Center<br/>
                PT SURYA SEGARA HANA
              </div>
            </div>
          ...
          ">
            <div style="
              ...
              border-right: 2px solid #000000;
            ">
              Certificate Number: ${cert.nomor_sertifikat}
            </div>
            <div style="
              padding-right: 30px;
              padding-bottom: 8px;
